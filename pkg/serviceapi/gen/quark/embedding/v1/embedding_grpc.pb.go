...
const (
	EmbeddingService_Embed_FullMethodName = "/quark.embedding.v1.EmbeddingService/Embed"
)
...
//
// EmbeddingService creates deterministic or provider-backed text embeddings.
...
var EmbeddingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "quark.embedding.v1.EmbeddingService",
	...
	Metadata: "quark/embedding/v1/embedding.proto",
}
