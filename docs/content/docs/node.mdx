...
description: "The full Node spec — categories, lifecycle state machine, multi-tenancy, NATS messaging design, persistence layout, REST API, and CLI reference."
...
sources, functions, stores, endpoints, policies — is a **Node** identified by
a Docker-style URI (`category/implementation:version`).
