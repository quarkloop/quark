...
./cli/quarkctl system deploy -f example/simple-streaming/system.quark.ts -n alice

# Deploy the same file in a different namespace
./cli/quarkctl system deploy -f example/simple-streaming/system.quark.ts -n bob

# Verify deployment
./cli/quarkctl system list -n alice
./cli/quarkctl node list -n alice -s monitor

# Watch events in real time
./cli/quarkctl event watch -n alice -s monitor
...
# Undeploy when done
./cli/quarkctl system delete monitor -n alice
./cli/quarkctl system delete monitor -n bob
```
