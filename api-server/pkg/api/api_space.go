...
// env values are forwarded as OS environment variables to the agent runtime.
...
// GetAgentStats calls GET /api/v1/agents/{id}/stats, which the api-server
// proxies to the agent runtime's local /stats endpoint.
func (c *ClientApi) GetAgentStats(ctx context.Context, id string) (map[string]interface{}, error) {
