	...
	return map[string]ToolDefinition{
		...
		"read": {
			...
			Parameters: map[string]interface{}{
				...
				"properties": map[string]interface{}{
					...
					"start_line": map[string]interface{}{"type": "integer", "description": "Starting line (1-based, optional)"},
					"end_line":   map[string]interface{}{"type": "integer", "description": "Ending line (1-based, optional)"},
				},
		...
		"write": {
			...
			Parameters: map[string]interface{}{
				...
				"properties": map[string]interface{}{
					"path":      map[string]interface{}{"type": "string", "description": "Absolute file path"},
					"operation": map[string]interface{}{"type": "string", "enum": []string{"write", "edit"}, "description": "write=create/overwrite, edit=partial edits"},
					"content":   map[string]interface{}{"type": "string", "description": "File content for write operation"},
					"edits":     map[string]interface{}{"type": "array", "description": "Edit operations for edit mode"},
				},
